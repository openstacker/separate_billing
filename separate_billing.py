...
class CatalystCloudShell(object):
    ...
    def get_subcommand_parser(self):
        ...
        submodule = importutils.import_module('separate_billing')
...
@arg('--customer', metavar='CUSTOMER_PREFIX', dest='CUSTOMER_PREFIX',
     required=True,
     help='The prefix for a particular customer to get the cost.')
...
def get_customer_cost(invoices, customer_prefix):
    ...
    print("Total cost for customer [%s] for the month of [%s] is : $%.2f" %
